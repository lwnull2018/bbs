package com.bbs.remark.config;


import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.bbs.remark.filter.KickoutSessionFilter;
import com.bbs.remark.shiro.MyRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        filterMap.put("/m.html", "anon");
        filterMap.put("/pc.html", "anon");
        filterMap.put("/note.html", "anon");
        filterMap.put("/mnote.html", "anon");
        filterMap.put("/note/*", "anon");
